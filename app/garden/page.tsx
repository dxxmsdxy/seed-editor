        ...
        <div className="ui-panel-container">
          <div className={`recent-seeds ui-panel ${minimizedPanels.recentSeeds ? 'minimized' : ''}`}>
            ...
            <ul role="list" className="ui-list disable-scrollbars">
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed999.png" loading="lazy"/></div>
              </li>
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed7615014902.png" loading="lazy"/></div>
              </li>
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed2203320320000.png" loading="lazy"/></div>
              </li>
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed1239187122883187151293600392.png" loading="lazy"/></div>
              </li>
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed85418030059554038646478733380.png" loading="lazy"/></div>
              </li>
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed99035203142830599563062018304.png" loading="lazy"/></div>
              </li>
              <li>
                <div className="recent-seeds-item"><img src="/seeds/seed973175613425012973423561801761.png" loading="lazy"/></div>
              </li>
